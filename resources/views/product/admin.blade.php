                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="table-responsive" ng-hide="loading_products">
                            <table class="table" ng-init="AdminListAllProducts(0)">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Type</th>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Picture edit</h5>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-white-50 text-danger" ng-show="has_error"><% errors.item %></small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <small class="form-text text-white-50 text-danger" ng-show="has_error"><% errors.price %></small>
                            </div>
                            <div class="form-group">
                                    ...
                                    <small class="form-text text-white-50 text-danger" ng-show="has_error"><% errors.minimum_stock %></small>
                            </div>
                            <div class="form-group">
                                    ...
                                    <small class="form-text text-white-50 text-danger" ng-show="has_error"><% errors.barcode %></small>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <small class="form-text text-white-50 text-danger" ng-show="has_error"><% errors.qr_code %></small>
                            </div>
                            <div class="form-group">
                                    ...
                                    <small class="form-text text-white-50 text-danger" ng-show="has_error"><% errors.items_on_box %></small>
                            </div>
                            <div class="form-group">
                                    ...
                                    <small class="form-text text-white-50 text-danger" ng-show="has_error"><% errors.gross_price %></small>
                            </div>
