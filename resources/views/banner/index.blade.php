...
<div class="container-fluid" ng-controller="BannerController">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">ORDER STATUSES</h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <a href="#" ng-click="OpenModalCreateBanner()" class="btn btn-project pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Create Banner</a>
                <ol class="breadcrumb">
        ...
        <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <img src="{{ asset('public/30.gif') }}" ng-show="loading_banners"/>

                        <div class="row" ng-hide="loading_banners">
                          <div class="col-md-1">
                        ...
                        <div class="table-responsive" ng-hide="loading_banners">
                            <table class="table" ng-init="AdminListAllBanners(0)">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    <tr ng-repeat="banner in banners">
                                        ...
                                        <td>
                                            <button class="btn btn-project" ng-click="EditBanner(banner.id)"><i class="fa fa-edit"></i></button>
                                            <button class="btn btn-danger" ng-click="DeleteBanner(banner.id)"><i class="fa fa-times"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div>
                          <label for="SizePicture">Picture size 728 x 196</label>
                          </div>
